...
ALTER TABLE WeatherObserved ADD COLUMN IF NOT EXISTS id text;
...
ALTER TABLE WeatherObserved ADD COLUMN IF NOT EXISTS pressureTendency text;
ALTER TABLE WeatherObserved ADD COLUMN IF NOT EXISTS refDevice text;
...
ALTER TABLE WeatherObserved ADD COLUMN IF NOT EXISTS seeAlso text;
...
ALTER TABLE WeatherObserved ADD COLUMN IF NOT EXISTS visibility text;
...
ALTER TABLE WeatherObserved ADD COLUMN IF NOT EXISTS title text;
ALTER TABLE WeatherObserved ADD COLUMN IF NOT EXISTS displayPage text;
...
ALTER TABLE IotService ADD COLUMN IF NOT EXISTS displayPage text;
