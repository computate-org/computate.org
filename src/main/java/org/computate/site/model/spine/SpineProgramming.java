 ...
 * AName: a SPINE Programming lesson
 ...
 * 
 * PublicRead: true
 * SearchPageUri: /en-us/search/spine-programming
 * EditPageUri: /en-us/edit/spine-programming/{pageId}
 * DisplayPageUri: /en-us/view/spine-programming/{pageId}
 * ApiUri: /en-us/api/spine-programming
 * ApiMethod:
 *   Search:
 *   GET:
 *   PATCH:
 ...
 *     SuperAdmin:
 */
public class SpineProgramming extends SpineProgrammingGen<BaseResult> {
   ...
   * Ignore: true
   */
  protected void _prerequisiteArticleSearch(Promise<SearchList<SpineProgramming>> promise) {
    SearchList<SpineProgramming> l = new SearchList<>();
  ...
  protected void _prerequisiteArticles(Wrap<JsonArray> w) {
    ...
    prerequisiteArticleSearch.getList().stream().forEach(prerequisiteArticle -> {
        ...
        obj.remove(SpineProgramming.VAR_prerequisiteArticles);
        obj.remove(SpineProgramming.VAR_prerequisiteArticleIds);
        JsonObject obj2 = new JsonObject();
        obj2.put(SpineProgramming.VAR_pageId, obj.getString(SpineProgramming.VAR_pageId));
        obj2.put(SpineProgramming.VAR_name, obj.getString(SpineProgramming.VAR_name));
        obj2.put(SpineProgramming.VAR_pageImageUri, obj.getString(SpineProgramming.VAR_pageImageUri));
        obj2.put(SpineProgramming.VAR_pageImageWidth, obj.getString(SpineProgramming.VAR_pageImageWidth));
        obj2.put(SpineProgramming.VAR_pageImageHeight, obj.getString(SpineProgramming.VAR_pageImageHeight));
        obj2.put(SpineProgramming.VAR_pageImageAlt, obj.getString(SpineProgramming.VAR_pageImageAlt));
        obj2.put(SpineProgramming.VAR_displayPage, obj.getString(SpineProgramming.VAR_displayPage));
        array.add(obj2);
    });
    w.o(array);
  }
   ...
   * Ignore: true
   */
  protected void _nextArticleSearch(Promise<SearchList<SpineProgramming>> promise) {
    SearchList<SpineProgramming> l = new SearchList<>();
  ...
  protected void _nextArticles(Wrap<JsonArray> w) {
    ...
    nextArticleSearch.getList().stream().forEach(nextArticle -> {
        ...
        obj.remove(SpineProgramming.VAR_nextArticles);
        obj.remove(SpineProgramming.VAR_nextArticleIds);
        JsonObject obj2 = new JsonObject();
        obj2.put(SpineProgramming.VAR_pageId, obj.getString(SpineProgramming.VAR_pageId));
        obj2.put(SpineProgramming.VAR_name, obj.getString(SpineProgramming.VAR_name));
        obj2.put(SpineProgramming.VAR_pageImageUri, obj.getString(SpineProgramming.VAR_pageImageUri));
   ...
   * Ignore: true
   */
  protected void _relatedArticleSearch(Promise<SearchList<SpineProgramming>> promise) {
    SearchList<SpineProgramming> l = new SearchList<>();
  ...
  protected void _relatedArticles(Wrap<JsonArray> w) {
    ...
    relatedArticleSearch.getList().stream().forEach(relatedArticle -> {
        ...
        obj.remove(SpineProgramming.VAR_relatedArticles);
        obj.remove(SpineProgramming.VAR_relatedArticleIds);
        JsonObject obj2 = new JsonObject();
        obj2.put(SpineProgramming.VAR_pageId, obj.getString(SpineProgramming.VAR_pageId));
        obj2.put(SpineProgramming.VAR_name, obj.getString(SpineProgramming.VAR_name));
        obj2.put(SpineProgramming.VAR_pageImageUri, obj.getString(SpineProgramming.VAR_pageImageUri));
