...
public class CaseStudy extends CaseStudyGen<BaseResult> {
   ...
   * DocValues: true
   * Persist: true
   * DisplayName: case study description
   * Description: The case study description. 
   * HtmRow: 3
   * HtmCell: 3
   * HtmColumn: 3
   * Facet: true
  ...
  protected void _description(Wrap<String> w) {
	...
	protected void _objectTitle(Wrap<String> w) {
		w.o(String.format("%s — %s", CaseStudy_NameAdjectiveSingular_enUS, title));
	}
