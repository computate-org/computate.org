...
public class CompanyWebsiteEnUSGenApiServiceImpl extends BaseApiServiceImpl implements CompanyWebsiteEnUSGenApiService {
    ...
    user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
      try {
        siteRequest.setLang("enUS");
              searchCompanyWebsiteList(siteRequest, false, true, false, "GET").onSuccess(listCompanyWebsite -> {
  ...
  public void patchCompanyWebsite(JsonObject body, ServiceRequest serviceRequest, Handler<AsyncResult<ServiceResponse>> eventHandler) {
    ...
    user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
      try {
        ...
        String COMPANYWEBSITE = siteRequest.getServiceRequest().getParams().getJsonObject("path").getString("COMPANYWEBSITE");
        List<String> groups = Optional.ofNullable(siteRequest.getGroups()).orElse(new ArrayList<>());
        MultiMap form = MultiMap.caseInsensitiveMultiMap();
        form.add("grant_type", "urn:ietf:params:oauth:grant-type:uma-ticket");
        form.add("audience", config.getString(ComputateConfigKeys.AUTH_CLIENT));
        form.add("response_mode", "permissions");
        form.add("permission", String.format("%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, "POST"));
        form.add("permission", String.format("%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, "PATCH"));
        form.add("permission", String.format("%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, "GET"));
        form.add("permission", String.format("%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, "DELETE"));
        form.add("permission", String.format("%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, "Admin"));
        form.add("permission", String.format("%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, "SuperAdmin"));
        if(pageId != null)
          form.add("permission", String.format("%s-%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, pageId, "PATCH"));
        webClient.post(
        ...
        .onComplete(authorizationDecisionResponse -> {
          try {
            ...
            JsonArray scopes = authorizationDecisionBody.stream().map(o -> (JsonObject)o).filter(o -> "COMPANYWEBSITE".equals(o.getString("rsname"))).findFirst().map(decision -> ((JsonObject)decision).getJsonArray("scopes")).orElse(new JsonArray());
            if(authorizationDecisionResponse.failed() || !scopes.contains("PATCH")) {
              ...
              searchCompanyWebsiteList(siteRequest, true, false, true, "PATCH").onSuccess(listCompanyWebsite -> {
                try {
                  ...
                  apiRequest.setId(Optional.ofNullable(listCompanyWebsite.first()).map(o2 -> o2.getPageId().toString()).orElse(null));
  ...
  public void patchCompanyWebsiteFuture(JsonObject body, ServiceRequest serviceRequest, Handler<AsyncResult<ServiceResponse>> eventHandler) {
    ...
    user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
      try {
        ...
        searchCompanyWebsiteList(siteRequest, false, true, true, "PATCH").onSuccess(listCompanyWebsite -> {
          try {
            ...
            if(o != null) {
              ...
              apiRequest.setId(Optional.ofNullable(listCompanyWebsite.first()).map(o3 -> o3.getPageId().toString()).orElse(null));
              JsonObject jsonObject = JsonObject.mapFrom(o);
              o2 = jsonObject.mapTo(CompanyWebsite.class);
              ...
              String m = String.format("%s %s not found", "website", null);
  ...
  public Future<CompanyWebsite> patchCompanyWebsiteFuture(CompanyWebsite o, Boolean inheritPrimaryKey) {
  ...
  public void postCompanyWebsite(JsonObject body, ServiceRequest serviceRequest, Handler<AsyncResult<ServiceResponse>> eventHandler) {
    ...
    user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
      try {
        ...
        form.add("permission", String.format("%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, "SuperAdmin"));
        if(pageId != null)
          form.add("permission", String.format("%s-%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, pageId, "POST"));
        webClient.post(
            config.getInteger(ComputateConfigKeys.AUTH_PORT)
            , config.getString(ComputateConfigKeys.AUTH_HOST_NAME)
            , config.getString(ComputateConfigKeys.AUTH_TOKEN_URI)
  ...
  public void putimportCompanyWebsite(JsonObject body, ServiceRequest serviceRequest, Handler<AsyncResult<ServiceResponse>> eventHandler) {
    ...
    user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
      try {
        ...
        form.add("permission", String.format("%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, "SuperAdmin"));
        if(pageId != null)
          form.add("permission", String.format("%s-%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, pageId, "PUT"));
        webClient.post(
            config.getInteger(ComputateConfigKeys.AUTH_PORT)
            , config.getString(ComputateConfigKeys.AUTH_HOST_NAME)
            , config.getString(ComputateConfigKeys.AUTH_TOKEN_URI)
  ...
  public void templateSearchPageCompanyWebsite(JsonObject ctx, CompanyWebsitePage page, SearchList<CompanyWebsite> listCompanyWebsite, Promise<String> promise) {
    try {
      ...
      if(result == null || !Files.exists(resourceTemplatePath)) {
        String template = Files.readString(Path.of(siteTemplatePath, "en-us/search/website/CompanyWebsiteSearchPage.htm"), Charset.forName("UTF-8"));
  ...
  public void editpageCompanyWebsite(ServiceRequest serviceRequest, Handler<AsyncResult<ServiceResponse>> eventHandler) {
    ...
    user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
      try {
        ...
        form.add("permission", String.format("%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, "SuperAdmin"));
        if(pageId != null)
          form.add("permission", String.format("%s-%s#%s", CompanyWebsite.CLASS_AUTH_RESOURCE, pageId, "GET"));
        webClient.post(
            config.getInteger(ComputateConfigKeys.AUTH_PORT)
              , config.getString(ComputateConfigKeys.AUTH_HOST_NAME)
              , config.getString(ComputateConfigKeys.AUTH_TOKEN_URI)
  ...
  public void templateEditPageCompanyWebsite(JsonObject ctx, CompanyWebsitePage page, SearchList<CompanyWebsite> listCompanyWebsite, Promise<String> promise) {
    try {
      ...
      Path resourceTemplatePath = Path.of(siteTemplatePath, pageTemplateUri);
      if(result == null || !Files.exists(resourceTemplatePath)) {
        String template = Files.readString(Path.of(siteTemplatePath, "en-us/edit/website/CompanyWebsiteEditPage.htm"), Charset.forName("UTF-8"));
        String renderedTemplate = jinjava.render(template, ctx.getMap());
        promise.complete(renderedTemplate);
      } else if(pageTemplateUri.endsWith(".md")) {
        String template = siteTemplatePath == null ? Resources.toString(Resources.getResource(resourceTemplatePath.toString()), StandardCharsets.UTF_8) : Files.readString(resourceTemplatePath, Charset.forName("UTF-8"));
  ...
  public Future<SearchList<CompanyWebsite>> searchCompanyWebsiteList(SiteRequest siteRequest, Boolean populate, Boolean store, Boolean modify, String scope) {
  ...
  public Future<CompanyWebsite> unindexCompanyWebsite(CompanyWebsite o) {
    ...
    try {
      ...
      o.promiseDeepForClass(siteRequest).onSuccess(a -> {
        ...
        String query = String.format("filter(%s:%s)", CompanyWebsite.VAR_solrId, o.obtainForClass(CompanyWebsite.VAR_solrId));
