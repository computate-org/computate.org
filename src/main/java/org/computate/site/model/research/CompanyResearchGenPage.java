...
public class CompanyResearchGenPage extends CompanyResearchGenPageGen<PageLayout> {
  ...
  protected void _pageResponse(Wrap<String> w) {
    if(searchListCompanyResearch_ != null)
      w.o(JsonObject.mapFrom(searchListCompanyResearch_.getResponse()).toString());
  }

  @Override
  protected void _stats(Wrap<SolrResponse.Stats> w) {
    w.o(searchListCompanyResearch_.getResponse().getStats());
  }

  @Override
  protected void _facetCounts(Wrap<SolrResponse.FacetCounts> w) {
    w.o(searchListCompanyResearch_.getResponse().getFacetCounts());
  }
  ...
  protected void _pagination(JsonObject pagination) {
    ...
    Long foundNum = searchListCompanyResearch_.getResponse().getResponse().getNumFound().longValue();
  ...
  protected void _query(JsonObject query) {
    ...
    Long num = searchListCompanyResearch_.getResponse().getResponse().getNumFound().longValue();
    String q = "*:*";
