 ...
 * Generated: true
 **/
public class ComputateCourseGenPage extends ComputateCourseGenPageGen<BaseModelPage> {

  /**
   * {@inheritDoc}
   * Ignore: true
   **/
  protected void _searchListComputateCourse_(Wrap<SearchList<ComputateCourse>> w) {
  }

  @Override
  protected void _pageResponse(Wrap<String> w) {
    if(searchListComputateCourse_ != null)
      w.o(JsonObject.mapFrom(searchListComputateCourse_.getResponse()).toString());
  }

  @Override
  protected void _stats(Wrap<SolrResponse.Stats> w) {
    w.o(searchListComputateCourse_.getResponse().getStats());
  }

  @Override
  protected void _facetCounts(Wrap<SolrResponse.FacetCounts> w) {
    w.o(searchListComputateCourse_.getResponse().getFacetCounts());
  }

  @Override
  protected void _pagination(JsonObject pagination) {
    JsonArray pages = new JsonArray();
    Long start = searchListComputateCourse_.getStart().longValue();
    Long rows = searchListComputateCourse_.getRows().longValue();
    Long foundNum = searchListComputateCourse_.getResponse().getResponse().getNumFound().longValue();
  ...
  protected void _varsQ(JsonObject vars) {
    ComputateCourse.varsQForClass().forEach(var -> {
      JsonObject json = new JsonObject();
      json.put("var", var);
      json.put("displayName", Optional.ofNullable(ComputateCourse.displayNameComputateCourse(var)).map(d -> StringUtils.isBlank(d) ? var : d).orElse(var));
      json.put("classSimpleName", Optional.ofNullable(ComputateCourse.classSimpleNameComputateCourse(var)).map(d -> StringUtils.isBlank(d) ? var : d).orElse(var));
      json.put("val", Optional.ofNullable(searchListComputateCourse_.getRequest().getQuery()).filter(fq -> fq.startsWith(ComputateCourse.varIndexedComputateCourse(var) + ":")).map(s -> SearchTool.unescapeQueryChars(StringUtils.substringAfter(s, ":"))).orElse(null));
      vars.put(var, json);
    });
  }
  ...
  protected void _varsFq(JsonObject vars) {
    ...
    ComputateCourse.varsFqForClass().forEach(var -> {
      String varIndexed = ComputateCourse.varIndexedComputateCourse(var);
      String varStored = ComputateCourse.varStoredComputateCourse(var);
      JsonObject json = new JsonObject();
      json.put("var", var);
      ...
      json.put("displayName", Optional.ofNullable(ComputateCourse.displayNameComputateCourse(var)).map(d -> StringUtils.isBlank(d) ? var : d).orElse(var));
      json.put("classSimpleName", Optional.ofNullable(ComputateCourse.classSimpleNameComputateCourse(var)).map(d -> StringUtils.isBlank(d) ? var : d).orElse(var));
      json.put("val", searchListComputateCourse_.getRequest().getFilterQueries().stream().filter(fq -> fq.startsWith(ComputateCourse.varIndexedComputateCourse(var) + ":")).findFirst().map(s -> SearchTool.unescapeQueryChars(StringUtils.substringAfter(s, ":"))).orElse(null));
  ...
  protected void _varsRange(JsonObject vars) {
    ComputateCourse.varsRangeForClass().forEach(var -> {
      String varIndexed = ComputateCourse.varIndexedComputateCourse(var);
      JsonObject json = new JsonObject();
      json.put("var", var);
      json.put("displayName", Optional.ofNullable(ComputateCourse.displayNameComputateCourse(var)).map(d -> StringUtils.isBlank(d) ? var : d).orElse(var));
  ...
  protected void _query(JsonObject query) {
    ...
    Long num = searchListComputateCourse_.getResponse().getResponse().getNumFound().longValue();
    String q = "*:*";
    ...
    Long rows1 = Optional.ofNullable(searchListComputateCourse_).map(l -> l.getRows()).orElse(10L);
    Long start1 = Optional.ofNullable(searchListComputateCourse_).map(l -> l.getStart()).orElse(1L);
    ...
    for(String fq : Optional.ofNullable(searchListComputateCourse_).map(l -> l.getFilterQueries()).orElse(Arrays.asList())) {
      if(!StringUtils.contains(fq, "(")) {
        String fq1 = ComputateCourse.searchVarComputateCourse(StringUtils.substringBefore(fq, ":"));
        String fq2 = StringUtils.substringAfter(fq, ":");
        if(!StringUtils.startsWithAny(fq, "classCanonicalNames_", "archived_", "deleted_", "sessionId", "userKeys"))
          fqs.put(fq1, new JsonObject().put("var", fq1).put("val", fq2).put("displayName", ComputateCourse.displayNameForClass(fq1)));
        }
      }
    query.put("fq", fqs);

    JsonArray sorts = new JsonArray();
    for(String sort : Optional.ofNullable(searchListComputateCourse_).map(l -> l.getSorts()).orElse(Arrays.asList())) {
      String sort1 = ComputateCourse.searchVarComputateCourse(StringUtils.substringBefore(sort, " "));
      sorts.add(new JsonObject().put("var", sort1).put("order", StringUtils.substringAfter(sort, " ")).put("displayName", ComputateCourse.displayNameForClass(sort1)));
    }
  ...
  protected void _rangeGap(Wrap<String> w) {
    if(serviceRequest.getParams().getJsonObject("query").getString("facet.range.gap", null) != null)
      w.o(Optional.ofNullable(searchListComputateCourse_.getFacetRangeGap()).orElse(null));
  }
  ...
  protected void _rangeEnd(Wrap<ZonedDateTime> w) {
    if(serviceRequest.getParams().getJsonObject("query").getString("facet.range.end", null) != null)
      w.o(Optional.ofNullable(searchListComputateCourse_.getFacetRangeEnd()).map(s -> TimeTool.parseZonedDateTime(defaultTimeZone, s)).orElse(null));
  }
  ...
  protected void _rangeStart(Wrap<ZonedDateTime> w) {
    if(serviceRequest.getParams().getJsonObject("query").getString("facet.range.start", null) != null)
      w.o(Optional.ofNullable(searchListComputateCourse_.getFacetRangeStart()).map(s -> TimeTool.parseZonedDateTime(defaultTimeZone, s)).orElse(null));
  }
  ...
  protected void _defaultRangeVar(Wrap<String> w) {
    w.o(Optional.ofNullable(searchListComputateCourse_.getFacetRanges()).orElse(Optional.ofNullable(defaultRangeStats).map(s -> Arrays.asList(s.getString("defaultRangeVar"))).orElse(Arrays.asList())).stream().findFirst().map(v -> { if(v.contains("}")) return StringUtils.substringBefore(StringUtils.substringAfterLast(v, "}"), "_"); else return ComputateCourse.searchVarComputateCourse(v); }).orElse("created"));
  }

  @Override
  protected void _defaultFacetSort(Wrap<String> w) {
    w.o(Optional.ofNullable(searchListComputateCourse_.getFacetSort()).orElse("index"));
  }

  @Override
  protected void _defaultFacetLimit(Wrap<Integer> w) {
    w.o(Optional.ofNullable(searchListComputateCourse_.getFacetLimit()).orElse(1));
  }

  @Override
  protected void _defaultFacetMinCount(Wrap<Integer> w) {
    w.o(Optional.ofNullable(searchListComputateCourse_.getFacetMinCount()).orElse(1));
  }

  @Override
  protected void _defaultPivotMinCount(Wrap<Integer> w) {
    w.o(Optional.ofNullable(searchListComputateCourse_.getFacetPivotMinCount()).orElse(0));
  }
  ...
  protected void _defaultFieldListVars(List<String> l) {
    Optional.ofNullable(searchListComputateCourse_.getFields()).orElse(Arrays.asList()).forEach(varStored -> {
      ...
      for(String part : parts) {
        if(StringUtils.isNotBlank(part)) {
          String var = ComputateCourse.searchVarComputateCourse(part);
  ...
  protected void _defaultStatsVars(List<String> l) {
    Optional.ofNullable(searchListComputateCourse_.getStatsFields()).orElse(Arrays.asList()).forEach(varIndexed -> {
  ...
  protected void _defaultPivotVars(List<String> l) {
    Optional.ofNullable(searchListComputateCourse_.getFacetPivots()).orElse(Arrays.asList()).forEach(facetPivot -> {
   ...
   * {@inheritDoc}
   **/
  protected void _listComputateCourse(JsonArray l) {
    Optional.ofNullable(searchListComputateCourse_).map(o -> o.getList()).orElse(Arrays.asList()).stream().map(o -> JsonObject.mapFrom(o)).forEach(o -> l.add(o));
  }

  protected void _computateCourseCount(Wrap<Integer> w) {
    w.o(searchListComputateCourse_ == null ? 0 : searchListComputateCourse_.size());
  }

  protected void _computateCourse_(Wrap<ComputateCourse> w) {
    if(computateCourseCount == 1 && Optional.ofNullable(siteRequest_.getServiceRequest().getParams().getJsonObject("path")).map(o -> o.getString("id")).orElse(null) != null)
      w.o(searchListComputateCourse_.get(0));
  }

  protected void _pk(Wrap<Long> w) {
    if(computateCourse_ != null)
      w.o(computateCourse_.getPk());
  }

  protected void _id(Wrap<String> w) {
    if(computateCourse_ != null)
      w.o(computateCourse_.getId());
  }
  ...
  protected void _pageTitle(Wrap<String> c) {
    if(computateCourse_ != null && computateCourse_.getObjectTitle() != null)
      c.o(computateCourse_.getObjectTitle());
    else if(computateCourse_ != null)
      c.o("courses");
    else if(searchListComputateCourse_ == null || computateCourseCount == 0)
      c.o("no course found");
    else
      c.o("courses");
  }
  ...
  protected void _pageDescription(Wrap<String> c) {
      c.o("Take an exciting hands-on course on your own computer with computate");
  }

  @Override
  protected void _pageImageUri(Wrap<String> c) {
      c.o("/png/course-999.png");
  }
  ...
  protected void _pageUriComputateCourse(Wrap<String> c) {
      c.o("/course");
  }
}
