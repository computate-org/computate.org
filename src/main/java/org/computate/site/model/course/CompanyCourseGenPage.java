 ...
 * Generated: true
 **/
public class CompanyCourseGenPage extends CompanyCourseGenPageGen<BaseModelPage> {

  /**
   * {@inheritDoc}
   * Ignore: true
   **/
  protected void _searchListCompanyCourse_(Wrap<SearchList<CompanyCourse>> w) {
  }
  ...
  protected void _varsQ(JsonObject vars) {
    CompanyCourse.varsQForClass().forEach(var -> {
      JsonObject json = new JsonObject();
      json.put("var", var);
      json.put("displayName", Optional.ofNullable(CompanyCourse.displayNameCompanyCourse(var)).map(d -> StringUtils.isBlank(d) ? var : d).orElse(var));
      ...
      json.put("val", Optional.ofNullable(searchListCompanyCourse_.getRequest().getQuery()).filter(fq -> fq.startsWith(CompanyCourse.varIndexedCompanyCourse(var) + ":")).map(s -> SearchTool.unescapeQueryChars(StringUtils.substringAfter(s, ":"))).orElse(null));
      vars.put(var, json);
    });
  }
  ...
  protected void _varsFq(JsonObject vars) {
    ...
    CompanyCourse.varsFqForClass().forEach(var -> {
      ...
      json.put("displayName", Optional.ofNullable(CompanyCourse.displayNameCompanyCourse(var)).map(d -> StringUtils.isBlank(d) ? var : d).orElse(var));
      json.put("classSimpleName", Optional.ofNullable(CompanyCourse.classSimpleNameCompanyCourse(var)).map(d -> StringUtils.isBlank(d) ? var : d).orElse(var));
      json.put("val", searchListCompanyCourse_.getRequest().getFilterQueries().stream().filter(fq -> fq.startsWith(CompanyCourse.varIndexedCompanyCourse(var) + ":")).findFirst().map(s -> SearchTool.unescapeQueryChars(StringUtils.substringAfter(s, ":"))).orElse(null));
  ...
  protected void _varsRange(JsonObject vars) {
    CompanyCourse.varsRangeForClass().forEach(var -> {
      String varIndexed = CompanyCourse.varIndexedCompanyCourse(var);
      JsonObject json = new JsonObject();
      json.put("var", var);
      json.put("displayName", Optional.ofNullable(CompanyCourse.displayNameCompanyCourse(var)).map(d -> StringUtils.isBlank(d) ? var : d).orElse(var));
  ...
  protected void _query(JsonObject query) {
    ...
    Long rows1 = Optional.ofNullable(searchListCompanyCourse_).map(l -> l.getRows()).orElse(10L);
    Long start1 = Optional.ofNullable(searchListCompanyCourse_).map(l -> l.getStart()).orElse(1L);
    ...
    for(String fq : Optional.ofNullable(searchListCompanyCourse_).map(l -> l.getFilterQueries()).orElse(Arrays.asList())) {
    ...
    for(String sort : Optional.ofNullable(searchListCompanyCourse_).map(l -> l.getSorts()).orElse(Arrays.asList())) {
      String sort1 = CompanyCourse.searchVarCompanyCourse(StringUtils.substringBefore(sort, " "));
      sorts.add(new JsonObject().put("var", sort1).put("order", StringUtils.substringAfter(sort, " ")).put("displayName", CompanyCourse.displayNameForClass(sort1)));
    }
  ...
  protected void _rangeGap(Wrap<String> w) {
    if(serviceRequest.getParams().getJsonObject("query").getString("facet.range.gap", null) != null)
      w.o(Optional.ofNullable(searchListCompanyCourse_.getFacetRangeGap()).orElse(null));
  }
  ...
  protected void _rangeEnd(Wrap<ZonedDateTime> w) {
    if(serviceRequest.getParams().getJsonObject("query").getString("facet.range.end", null) != null)
      w.o(Optional.ofNullable(searchListCompanyCourse_.getFacetRangeEnd()).map(s -> TimeTool.parseZonedDateTime(defaultTimeZone, s)).orElse(null));
  }
  ...
  protected void _rangeStart(Wrap<ZonedDateTime> w) {
    if(serviceRequest.getParams().getJsonObject("query").getString("facet.range.start", null) != null)
      w.o(Optional.ofNullable(searchListCompanyCourse_.getFacetRangeStart()).map(s -> TimeTool.parseZonedDateTime(defaultTimeZone, s)).orElse(null));
  }
  ...
  protected void _defaultRangeVar(Wrap<String> w) {
    w.o(Optional.ofNullable(searchListCompanyCourse_.getFacetRanges()).orElse(Optional.ofNullable(defaultRangeStats).map(s -> Arrays.asList(s.getString("defaultRangeVar"))).orElse(Arrays.asList())).stream().findFirst().map(v -> { if(v.contains("}")) return StringUtils.substringBefore(StringUtils.substringAfterLast(v, "}"), "_"); else return CompanyCourse.searchVarCompanyCourse(v); }).orElse("created"));
  }

  @Override
  protected void _defaultFacetSort(Wrap<String> w) {
    w.o(Optional.ofNullable(searchListCompanyCourse_.getFacetSort()).orElse("index"));
  }

  @Override
  protected void _defaultFacetLimit(Wrap<Integer> w) {
    w.o(Optional.ofNullable(searchListCompanyCourse_.getFacetLimit()).orElse(1));
  }

  @Override
  protected void _defaultFacetMinCount(Wrap<Integer> w) {
    w.o(Optional.ofNullable(searchListCompanyCourse_.getFacetMinCount()).orElse(1));
  }

  @Override
  protected void _defaultPivotMinCount(Wrap<Integer> w) {
    w.o(Optional.ofNullable(searchListCompanyCourse_.getFacetPivotMinCount()).orElse(0));
  }
  ...
  protected void _defaultFieldListVars(List<String> l) {
    Optional.ofNullable(searchListCompanyCourse_.getFields()).orElse(Arrays.asList()).forEach(varStored -> {
      ...
      for(String part : parts) {
        if(StringUtils.isNotBlank(part)) {
          String var = CompanyCourse.searchVarCompanyCourse(part);
  ...
  protected void _defaultStatsVars(List<String> l) {
    Optional.ofNullable(searchListCompanyCourse_.getStatsFields()).orElse(Arrays.asList()).forEach(varIndexed -> {
  ...
  protected void _defaultPivotVars(List<String> l) {
    Optional.ofNullable(searchListCompanyCourse_.getFacetPivots()).orElse(Arrays.asList()).forEach(facetPivot -> {
   ...
   * {@inheritDoc}
   **/
  protected void _listCompanyCourse(JsonArray l) {
    Optional.ofNullable(searchListCompanyCourse_).map(o -> o.getList()).orElse(Arrays.asList()).stream().map(o -> JsonObject.mapFrom(o)).forEach(o -> l.add(o));
  }

  protected void _companyCourseCount(Wrap<Integer> w) {
    w.o(searchListCompanyCourse_ == null ? 0 : searchListCompanyCourse_.size());
  }

  protected void _companyCourse_(Wrap<CompanyCourse> w) {
    if(companyCourseCount == 1 && Optional.ofNullable(siteRequest_.getServiceRequest().getParams().getJsonObject("path")).map(o -> o.getString("id")).orElse(null) != null)
      w.o(searchListCompanyCourse_.get(0));
  }

  protected void _pk(Wrap<Long> w) {
    if(companyCourse_ != null)
      w.o(companyCourse_.getPk());
  }

  protected void _id(Wrap<String> w) {
    if(companyCourse_ != null)
      w.o(companyCourse_.getId());
  }
  ...
  protected void _pageTitle(Wrap<String> c) {
    if(companyCourse_ != null && companyCourse_.getObjectTitle() != null)
      c.o(companyCourse_.getObjectTitle());
    else if(companyCourse_ != null)
      c.o("courses");
    else if(searchListCompanyCourse_ == null || companyCourseCount == 0)
      c.o("no course found");
    else
      c.o("courses");
  }
