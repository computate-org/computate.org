 ...
 *   PUTImport:
 * AuthGroup:
 *   WeatherObservedViewer:
 *     GET:
 *   WeatherObservedEditor:
 *     GET:
 *     POST:
 *     PATCH:
 *   SuperAdmin:
...
public class WeatherObserved extends WeatherObservedGen<BaseModel> {
	 ...
	 * HtmRowTitleOpen: WeatherObserved details
	 * HtmRow: 6
	 * HtmCell: 0
	 * Facet: true
	 **/
	 ...
	 * Facet: true
	 **/
	protected void _pressureTendency(Wrap<String> w) {
	}
	 ...
	 * Facet: true
	 **/
	protected void _visibility(Wrap<String> w) {
	}
