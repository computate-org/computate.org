 ...
 * 
 * PublicRead: true
 * SearchPageUri: /en-us/search/deploy-spine
 * EditPageUri: /en-us/edit/deploy-spine/{pageId}
 * DisplayPageUri: /en-us/learn/deploy-spine/{pageId}
 * ApiUri: /en-us/api/deploy-spine
 * ApiMethod:
 *   Search:
 *   GET:
 *   PATCH:
 ...
 *     SuperAdmin:
 */
public class DeploySpine extends DeploySpineGen<BaseResult> {
   ...
   * Ignore: true
   */
  protected void _prerequisiteArticleSearch(Promise<SearchList<DeploySpine>> promise) {
    SearchList<DeploySpine> l = new SearchList<>();
  ...
  protected void _prerequisiteArticles(Wrap<JsonArray> w) {
    ...
    prerequisiteArticleSearch.getList().stream().forEach(prerequisiteArticle -> {
        ...
        obj.remove(DeploySpine.VAR_prerequisiteArticles);
        obj.remove(DeploySpine.VAR_prerequisiteArticleIds);
        JsonObject obj2 = new JsonObject();
        obj2.put(DeploySpine.VAR_pageId, obj.getString(DeploySpine.VAR_pageId));
        obj2.put(DeploySpine.VAR_name, obj.getString(DeploySpine.VAR_name));
        obj2.put(DeploySpine.VAR_pageImageUri, obj.getString(DeploySpine.VAR_pageImageUri));
        obj2.put(DeploySpine.VAR_pageImageWidth, obj.getString(DeploySpine.VAR_pageImageWidth));
        obj2.put(DeploySpine.VAR_pageImageHeight, obj.getString(DeploySpine.VAR_pageImageHeight));
        obj2.put(DeploySpine.VAR_pageImageAlt, obj.getString(DeploySpine.VAR_pageImageAlt));
        obj2.put(DeploySpine.VAR_displayPage, obj.getString(DeploySpine.VAR_displayPage));
        array.add(obj2);
    });
    w.o(array);
  }
   ...
   * Ignore: true
   */
  protected void _nextArticleSearch(Promise<SearchList<DeploySpine>> promise) {
    SearchList<DeploySpine> l = new SearchList<>();
  ...
  protected void _nextArticles(Wrap<JsonArray> w) {
    ...
    nextArticleSearch.getList().stream().forEach(nextArticle -> {
        ...
        obj.remove(DeploySpine.VAR_nextArticles);
        obj.remove(DeploySpine.VAR_nextArticleIds);
        JsonObject obj2 = new JsonObject();
        obj2.put(DeploySpine.VAR_pageId, obj.getString(DeploySpine.VAR_pageId));
        obj2.put(DeploySpine.VAR_name, obj.getString(DeploySpine.VAR_name));
        obj2.put(DeploySpine.VAR_pageImageUri, obj.getString(DeploySpine.VAR_pageImageUri));
