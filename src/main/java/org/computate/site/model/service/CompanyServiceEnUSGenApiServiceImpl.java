...
public class CompanyServiceEnUSGenApiServiceImpl extends BaseApiServiceImpl implements CompanyServiceEnUSGenApiService {
		...
		user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", true).onSuccess(siteRequest -> {
			...
			webClient.post(
					...
					.sendForm(MultiMap.caseInsensitiveMultiMap()
							...
							.add("permission", String.format("%s-%s#%s", CompanyService.CLASS_SIMPLE_NAME, pageId, "PATCH"))
							...
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, "PUT"))
			).onFailure(ex -> {
					...
					if(!scopes.contains("PATCH")) {
						...
						searchCompanyServiceList(siteRequest, true, false, true).onSuccess(listCompanyService -> {
							try {
								...
								apiRequest.setId(Optional.ofNullable(listCompanyService.first()).map(o2 -> o2.getPageId()).orElse(null));
	...
	public Future<CompanyService> patchCompanyServiceFuture(CompanyService o, Boolean pageId) {
		...
		user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", true).onSuccess(siteRequest -> {
			...
			webClient.post(
					...
					.sendForm(MultiMap.caseInsensitiveMultiMap()
							...
							.add("audience", config.getString(ComputateConfigKeys.AUTH_CLIENT))
							.add("response_mode", "permissions")
							.add("permission", String.format("%s-%s#%s", CompanyService.CLASS_SIMPLE_NAME, pageId, "POST"))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, "GET"))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, config.getString(ComputateConfigKeys.AUTH_SCOPE_ADMIN)))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, config.getString(ComputateConfigKeys.AUTH_SCOPE_SUPER_ADMIN)))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, "POST"))
		...
		user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", true).onSuccess(siteRequest -> {
			...
			webClient.post(
					...
					.sendForm(MultiMap.caseInsensitiveMultiMap()
							...
							.add("audience", config.getString(ComputateConfigKeys.AUTH_CLIENT))
							.add("response_mode", "permissions")
							.add("permission", String.format("%s-%s#%s", CompanyService.CLASS_SIMPLE_NAME, pageId, "PUT"))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, "GET"))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, config.getString(ComputateConfigKeys.AUTH_SCOPE_ADMIN)))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, config.getString(ComputateConfigKeys.AUTH_SCOPE_SUPER_ADMIN)))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, "POST"))
		...
		user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", true).onSuccess(siteRequest -> {
			...
			webClient.post(
					...
					.sendForm(MultiMap.caseInsensitiveMultiMap()
							...
							.add("audience", config.getString(ComputateConfigKeys.AUTH_CLIENT))
							.add("response_mode", "permissions")
							.add("permission", String.format("%s-%s#%s", CompanyService.CLASS_SIMPLE_NAME, pageId, "GET"))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, config.getString(ComputateConfigKeys.AUTH_SCOPE_ADMIN)))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, config.getString(ComputateConfigKeys.AUTH_SCOPE_SUPER_ADMIN)))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, "GET"))
							.add("permission", String.format("%s#%s", CompanyService.CLASS_SIMPLE_NAME, "POST"))
